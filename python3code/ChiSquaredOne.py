...
print (count, "out of 10000 experiments had a chi-squared difference greater than or equal to %.2f" %
           observed_chi_squared)
print ("Probability that chance alone gave us a chi-squared greater than or equal to", "%.2f" % observed_chi_squared, "is", (count / float(num_runs)))
