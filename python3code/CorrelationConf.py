...
print ("We have ", conf_interval * 100, "% confidence that the true r", "is between: %.2f" % out[lower_bound], "and %.2f" % out[upper_bound])

print ("***** Bias Corrected Confidence Interval *****")
print ("We have", conf_interval * 100, "% confidence that the true r", "is between: %.2f" % out[
        bias_corr_lower_bound], "and %.2f" % out[bias_corr_upper_bound])
