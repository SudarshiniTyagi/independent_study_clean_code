...
countgood <- length(subset(out, out >= observed_number_of_heads))
...
cat (countgood, "out of", number_of_bootstraps, "times we got at least", observed_number_of_heads, "heads in", number_of_tosses, "tosses.")
cat ("Probability that chance alone gave us at least", observed_number_of_heads, "heads in", number_of_tosses, "tosses is", countgood / number_of_bootstraps, ".")
